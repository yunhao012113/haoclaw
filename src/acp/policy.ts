...
export function isAcpEnabledByPolicy(cfg: HaoclawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: HaoclawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: HaoclawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: HaoclawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: HaoclawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: HaoclawConfig, agentId: string): boolean {
