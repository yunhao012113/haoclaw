...
let originalHaoclawTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalHaoclawTestConsole = process.env.HAOCLAW_TEST_CONSOLE;
  process.env.HAOCLAW_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalHaoclawTestConsole === undefined) {
    delete process.env.HAOCLAW_TEST_CONSOLE;
  } else {
    process.env.HAOCLAW_TEST_CONSOLE = originalHaoclawTestConsole;
  }
