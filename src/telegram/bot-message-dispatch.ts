...
import type { HaoclawConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: HaoclawConfig, agentId: string) {
  try {
