...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof HaoclawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: HaoclawConfig; env: NodeJS.ProcessEnv }): {
  cfg: HaoclawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
