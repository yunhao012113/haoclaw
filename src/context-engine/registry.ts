...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("haoclaw.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: HaoclawConfig): Promise<ContextEngine> {
