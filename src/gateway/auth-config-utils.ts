import type { GatewayAuthConfig, HaoclawConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: HaoclawConfig, password: string): HaoclawConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
