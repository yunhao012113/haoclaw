...
import { type HaoclawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: HaoclawConfig): string[] {
...
export function listAgentsForGateway(cfg: HaoclawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: HaoclawConfig): string {
...
function resolveSessionStoreAgentId(cfg: HaoclawConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: HaoclawConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: HaoclawConfig): GatewaySessionsDefaults {
