...
export function hasAmbiguousGatewayAuthModeConfig(cfg: HaoclawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: HaoclawConfig): void {
