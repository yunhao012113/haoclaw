...
describe("gateway auth", () => {
  ...
  it("resolves token/password from HAOCLAW gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          HAOCLAW_GATEWAY_TOKEN: "env-token",
          HAOCLAW_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides HAOCLAW_GATEWAY_PASSWORD", () => {
