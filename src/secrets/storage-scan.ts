...
export function listAuthProfileStorePaths(config: HaoclawConfig, stateDir: string): string[] {
...
export function listAgentModelsJsonPaths(config: HaoclawConfig, stateDir: string): string[] {
