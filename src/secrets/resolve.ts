...
function resolveResolutionLimits(config: HaoclawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: HaoclawConfig): SecretProviderConfig {
