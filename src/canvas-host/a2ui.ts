...
export const A2UI_PATH = "/__haoclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__haoclaw__/canvas";

export const CANVAS_WS_PATH = "/__haoclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.haoclawCanvasA2UIAction.postMessage(...)
  // - Android: window.haoclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["haoclawCanvasA2UIAction"];
  ...
  globalThis.Haoclaw = globalThis.Haoclaw ?? {};
  globalThis.Haoclaw.postMessage = postToNode;
  globalThis.Haoclaw.sendUserAction = sendUserAction;
  globalThis.haoclawPostMessage = postToNode;
  globalThis.haoclawSendUserAction = sendUserAction;
