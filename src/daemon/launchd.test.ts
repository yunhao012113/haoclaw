...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.haoclaw.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", HAOCLAW_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("enables, bootstraps, and kickstarts the resolved label", async () => {
    ...
    const label = "ai.haoclaw.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.haoclaw.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when HAOCLAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.haoclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when HAOCLAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", HAOCLAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.haoclaw.jbphoenix.plist",
    },
    {
      name: "prefers HAOCLAW_LAUNCHD_LABEL over HAOCLAW_PROFILE",
      env: {
        HOME: "/Users/test",
        HAOCLAW_PROFILE: "jbphoenix",
        HAOCLAW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from HAOCLAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        HAOCLAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty HAOCLAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        HAOCLAW_PROFILE: "myprofile",
        HAOCLAW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.haoclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
