...
export function listWhatsAppAuthDirs(cfg: HaoclawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: HaoclawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: HaoclawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: HaoclawConfig): ResolvedWhatsAppAccount[] {
