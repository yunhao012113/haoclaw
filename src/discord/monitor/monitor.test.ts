...
describe("agent components", () => {
  const createCfg = (): HaoclawConfig => ({}) as HaoclawConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/haoclaw-sessions-test.json");
  });
