...
function resolveDefaultAccountId(cfg: HaoclawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: HaoclawConfig): boolean {
...
export function summarizeBindings(cfg: HaoclawConfig, bindings: AgentBinding[]): string[] {
