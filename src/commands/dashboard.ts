...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set HAOCLAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `haoclaw dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Haoclaw.");
  } else if (hint) {
    runtime.log(hint);
  }
}
