...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.haoclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("haoclaw hooks list")}`,
      `  ${formatCliCommand("haoclaw hooks enable <name>")}`,
      `  ${formatCliCommand("haoclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
