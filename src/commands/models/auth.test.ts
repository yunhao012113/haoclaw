...
describe("modelsAuthLoginCommand", () => {
  ...
  let currentConfig: HaoclawConfig;
  let lastUpdatedConfig: HaoclawConfig | null;
  ...
  beforeEach(() => {
    ...
    mocks.resolveAgentDir.mockReturnValue("/tmp/haoclaw/agents/main");
    mocks.resolveAgentWorkspaceDir.mockReturnValue("/tmp/haoclaw/workspace");
    mocks.resolveDefaultAgentWorkspaceDir.mockReturnValue("/tmp/haoclaw/workspace");
    mocks.loadValidConfigOrThrow.mockImplementation(async () => currentConfig);
    mocks.updateConfig.mockImplementation(
      async (mutator: (cfg: HaoclawConfig) => HaoclawConfig) => {
