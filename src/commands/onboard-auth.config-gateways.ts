...
export function applyVercelAiGatewayProviderConfig(cfg: HaoclawConfig): HaoclawConfig {
...
export function applyVercelAiGatewayConfig(cfg: HaoclawConfig): HaoclawConfig {
