    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["haoclaw directory self --channel slack", "Show the connected account identity."],
          [
            'haoclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["haoclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "haoclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.haoclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
