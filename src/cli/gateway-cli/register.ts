      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["haoclaw gateway run", "Run the gateway in the foreground."],
            ["haoclaw gateway status", "Show service status and probe reachability."],
            ["haoclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["haoclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.haoclaw.ai/cli/gateway")}\n`,
      ),
  );
