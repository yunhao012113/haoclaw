const DEFAULT_TAGLINE = "All your chats, one Haoclaw.";
...
const TAGLINES: string[] = [
  ...
  "I'll butter your workflow like a octopus roll: messy, delicious, effective.",
  ...
  "Built for humans, tuned for fast local automation.",
  ...
  "You had me at 'haoclaw gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.HAOCLAW_TAGLINE_INDEX;
