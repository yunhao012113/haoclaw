    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["haoclaw channels list", "List configured channels and auth profiles."],
          ["haoclaw channels status --probe", "Run channel status checks and probes."],
          [
            "haoclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["haoclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.haoclaw.ai/cli/channels",
        )}\n`,
    );
