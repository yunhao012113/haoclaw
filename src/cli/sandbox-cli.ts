...
const SANDBOX_EXAMPLES = {
  main: [
    ["haoclaw sandbox list", "List all sandbox containers."],
    ["haoclaw sandbox list --browser", "List only browser containers."],
    ["haoclaw sandbox recreate --all", "Recreate all containers."],
    ["haoclaw sandbox recreate --session main", "Recreate a specific session."],
    ["haoclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["haoclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["haoclaw sandbox list", "List all sandbox containers."],
    ["haoclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["haoclaw sandbox recreate --all", "Recreate all containers."],
    ["haoclaw sandbox recreate --session main", "Recreate a specific session."],
    ["haoclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["haoclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["haoclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["haoclaw sandbox explain", "Show effective sandbox config."],
    ["haoclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["haoclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["haoclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.haoclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
