...
export type ChannelAgentToolFactory = (params: { cfg?: HaoclawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: HaoclawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: HaoclawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: HaoclawConfig }) => boolean;
  supportsCards?: (params: { cfg: HaoclawConfig }) => boolean;
