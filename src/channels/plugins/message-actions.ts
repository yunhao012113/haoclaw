...
export function listChannelMessageActions(cfg: HaoclawConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: HaoclawConfig): boolean {
...
export function supportsChannelMessageCards(cfg: HaoclawConfig): boolean {
