...
import { discoverHaoclawPlugins } from "../../plugins/discovery.js";
import type { HaoclawPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, HaoclawPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["HAOCLAW_PLUGIN_CATALOG_PATHS", "HAOCLAW_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<HaoclawPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: HaoclawPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: HaoclawPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverHaoclawPlugins({ workspaceDir: options.workspaceDir });
