...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: HaoclawConfig): string | undefined {
  ...
  function listAccountIds(cfg: HaoclawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: HaoclawConfig): string {
