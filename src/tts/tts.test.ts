...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.HAOCLAW_TTS_PREFS;
      process.env.HAOCLAW_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.HAOCLAW_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: HaoclawConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
