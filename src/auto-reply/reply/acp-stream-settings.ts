...
function resolveAcpStreamCoalesceIdleMs(cfg: HaoclawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: HaoclawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: HaoclawConfig): AcpProjectionSettings {
