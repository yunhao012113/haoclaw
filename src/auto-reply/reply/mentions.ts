...
function resolveMentionPatterns(cfg: HaoclawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: HaoclawConfig | undefined, agentId?: string): RegExp[] {
