...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@haoclaw", { botUsername: "haoclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@haoclaw args", {
        botUsername: "haoclaw",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "haoclaw" })).toBe(
      "/help@otherbot",
    );
  });
