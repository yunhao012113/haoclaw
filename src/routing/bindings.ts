...
export function listBindings(cfg: HaoclawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: HaoclawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: HaoclawConfig) {
