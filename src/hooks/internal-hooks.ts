/**
 * Hook system for Haoclaw agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __haoclaw_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__haoclaw_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
