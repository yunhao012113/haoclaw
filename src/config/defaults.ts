...
function resolveAnthropicDefaultAuthMode(cfg: HaoclawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: HaoclawConfig): HaoclawConfig {
...
export function applyTalkApiKey(config: HaoclawConfig): HaoclawConfig {
...
export function applyTalkConfigNormalization(config: HaoclawConfig): HaoclawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: HaoclawConfig): HaoclawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: HaoclawConfig): HaoclawConfig {
...
export function applyLoggingDefaults(cfg: HaoclawConfig): HaoclawConfig {
...
export function applyContextPruningDefaults(cfg: HaoclawConfig): HaoclawConfig {
...
export function applyCompactionDefaults(cfg: HaoclawConfig): HaoclawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
