...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.HAOCLAW_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.HAOCLAW_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.HAOCLAW_SERVICE_MARKER = originalServiceMarker;
    }
  });
