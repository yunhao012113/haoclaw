...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: HaoclawConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: HaoclawConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__haoclawMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__haoclawMcporterColdStartWarned;
  });
