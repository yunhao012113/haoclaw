...
const loadHaoclawPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadHaoclawPlugins: (params: unknown) => loadHaoclawPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadHaoclawPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadHaoclawPluginsMock.mockClear();
  });
