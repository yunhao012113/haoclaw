...
export type HaoclawPluginConfigSchema = {
...
export type HaoclawPluginToolContext = {
...
export type HaoclawPluginToolFactory = (
  ctx: HaoclawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type HaoclawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type HaoclawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<HaoclawConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type HaoclawPluginGatewayMethod = {
  method: string;
 ...
 */
export type HaoclawPluginCommandDefinition = {
...
export type HaoclawPluginHttpRouteAuth = "gateway" | "plugin";
export type HaoclawPluginHttpRouteMatch = "exact" | "prefix";

export type HaoclawPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type HaoclawPluginHttpRouteParams = {
  path: string;
  handler: HaoclawPluginHttpRouteHandler;
  auth: HaoclawPluginHttpRouteAuth;
  match?: HaoclawPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type HaoclawPluginCliContext = {
  program: Command;
  config: HaoclawConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type HaoclawPluginCliRegistrar = (ctx: HaoclawPluginCliContext) => void | Promise<void>;

export type HaoclawPluginServiceContext = {
  config: HaoclawConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type HaoclawPluginService = {
  id: string;
  start: (ctx: HaoclawPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: HaoclawPluginServiceContext) => void | Promise<void>;
};

export type HaoclawPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type HaoclawPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: HaoclawPluginConfigSchema;
  register?: (api: HaoclawPluginApi) => void | Promise<void>;
  activate?: (api: HaoclawPluginApi) => void | Promise<void>;
};

export type HaoclawPluginModule =
  | HaoclawPluginDefinition
  | ((api: HaoclawPluginApi) => void | Promise<void>);

export type HaoclawPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | HaoclawPluginToolFactory,
    opts?: HaoclawPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: HaoclawPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: HaoclawPluginHttpRouteParams) => void;
  registerChannel: (registration: HaoclawPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: HaoclawPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: HaoclawPluginService) => void;
   ...
   */
  registerCommand: (command: HaoclawPluginCommandDefinition) => void;
