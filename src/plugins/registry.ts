...
import type {
  HaoclawPluginApi,
  HaoclawPluginChannelRegistration,
  HaoclawPluginCliRegistrar,
  HaoclawPluginCommandDefinition,
  HaoclawPluginHttpRouteAuth,
  HaoclawPluginHttpRouteMatch,
  HaoclawPluginHttpRouteHandler,
  HaoclawPluginHttpRouteParams,
  HaoclawPluginHookOptions,
  ProviderPlugin,
...
export type PluginToolRegistration = {
  pluginId: string;
  factory: HaoclawPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
};
...
export type PluginCliRegistration = {
  pluginId: string;
  register: HaoclawPluginCliRegistrar;
  commands: string[];
  source: string;
};
...
export type PluginServiceRegistration = {
  pluginId: string;
  service: HaoclawPluginService;
  source: string;
};

export type PluginCommandRegistration = {
  pluginId: string;
  command: HaoclawPluginCommandDefinition;
  source: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: HaoclawPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: HaoclawPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: HaoclawPluginHookOptions | undefined,
    config: HaoclawPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: HaoclawPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: HaoclawPluginChannelRegistration | ChannelPlugin,
  ) => {
    const normalized =
      typeof (registration as HaoclawPluginChannelRegistration).plugin === "object"
        ? (registration as HaoclawPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: HaoclawPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: HaoclawPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: HaoclawPluginCommandDefinition) => {
