...
export const PLUGIN_MANIFEST_FILENAME = "haoclaw.plugin.json";
...
// package.json "haoclaw" metadata (used for onboarding/catalog)
...
export type HaoclawPackageManifest = {
  extensions?: string[];
...
): HaoclawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
