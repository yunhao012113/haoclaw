...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveHaoclawAgentDir() returns mainAgentDir
    process.env.HAOCLAW_STATE_DIR = tmpDir;
    process.env.HAOCLAW_AGENT_DIR = mainAgentDir;
