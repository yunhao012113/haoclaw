...
function resolveAvatarSource(cfg: HaoclawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: HaoclawConfig, agentId: string): AgentAvatarResolution {
