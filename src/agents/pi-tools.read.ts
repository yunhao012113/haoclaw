...
function resolveAdaptiveReadMaxBytes(options?: HaoclawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createHaoclawReadTool(base, {
...
export function createHaoclawReadTool(
  base: AnyAgentTool,
  options?: HaoclawReadToolOptions,
): AnyAgentTool {
