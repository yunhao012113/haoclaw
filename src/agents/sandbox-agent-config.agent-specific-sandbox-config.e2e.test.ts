...
async function resolveContext(config: HaoclawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): HaoclawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
