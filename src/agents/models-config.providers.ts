...
type ModelsConfig = NonNullable<HaoclawConfig["models"]>;
...
export function normalizeGoogleModelId(id: string): string {
  ...
  // Preserve compatibility with earlier Haoclaw docs/config that pointed at a
...
export async function resolveImplicitCopilotProvider(params: {
  ...
  // Haoclaw keeps auth in auth-profiles and resolves runtime availability from that store.
