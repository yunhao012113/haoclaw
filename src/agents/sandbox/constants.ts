...
export const DEFAULT_SANDBOX_IMAGE = "haoclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "haoclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "haoclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "haoclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "haoclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "haoclaw-sandbox-browser";
