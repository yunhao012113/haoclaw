...
const CLEANUP_STATE_KEY = Symbol.for("haoclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("haoclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("haoclaw.sessionWriteLockWatchdogState");
