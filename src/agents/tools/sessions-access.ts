...
export function resolveSessionToolsVisibility(cfg: HaoclawConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: HaoclawConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: HaoclawConfig): AgentToAgentPolicy {
