...
function resolveMemoryToolContext(options: { config?: HaoclawConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: HaoclawConfig): MemoryCitationsMode {
