...
function asHaoclawConfig(config: Partial<HaoclawConfig>): HaoclawConfig {
  return config as HaoclawConfig;
}

function createToolConfig() {
  return asHaoclawConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: HaoclawConfig = createToolConfig()) {
