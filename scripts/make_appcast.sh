...
FEED_URL=${2:-"https://raw.githubusercontent.com/haoclaw/haoclaw/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/haoclaw/haoclaw/releases/download/v${VERSION}/"}
