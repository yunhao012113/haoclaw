...
- Keep product names in English: Haoclaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Haoclaw Gateway, use “Gateway 网关”.
