...
show_usage() {
    cat << EOF
clawlog - Haoclaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Haoclaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Haoclaw logs flow through the macOS unified log (subsystem: ai.haoclaw).
