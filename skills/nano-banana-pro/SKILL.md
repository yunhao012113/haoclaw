...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.haoclaw/haoclaw.json`
...
- The script prints a `MEDIA:` line for Haoclaw to auto-attach on supported chat providers.
