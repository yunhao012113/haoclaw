import type { HaoclawConfig, HaoclawPluginApi } from "haoclaw/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: HaoclawConfig): { id: string; name: string } {
