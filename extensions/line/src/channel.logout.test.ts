import type { HaoclawConfig, PluginRuntime, ResolvedLineAccount } from "haoclaw/plugin-sdk/line";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: HaoclawConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: HaoclawConfig; accountId: string }): Promise<{
