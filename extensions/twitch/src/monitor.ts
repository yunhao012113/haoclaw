...
import type { ReplyPayload, HaoclawConfig } from "haoclaw/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "haoclaw/plugin-sdk/twitch";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as HaoclawConfig;
