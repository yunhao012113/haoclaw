...
Official Voice Call plugin for **Haoclaw**.
...
Docs: `https://docs.haoclaw.ai/plugins/voice-call`
Plugin system: `https://docs.haoclaw.ai/plugin`

## Install (local dev)

### Option A: install via Haoclaw (recommended)
...
```bash
mkdir -p ~/.haoclaw/extensions
cp -R extensions/voice-call ~/.haoclaw/extensions/voice-call
cd ~/.haoclaw/extensions/voice-call && pnpm install
```
...
```bash
haoclaw voicecall call --to "+15555550123" --message "Hello from Haoclaw"
haoclaw voicecall continue --call-id <id> --message "Any questions?"
haoclaw voicecall speak --call-id <id> --message "One moment"
haoclaw voicecall end --call-id <id>
haoclaw voicecall status --call-id <id>
haoclaw voicecall tail
