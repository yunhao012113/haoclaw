import { createScopedChannelConfigBase } from "haoclaw/plugin-sdk/compat";
import {
...
} from "haoclaw/plugin-sdk/compat";
import {
...
} from "haoclaw/plugin-sdk/discord";
...
export const discordPlugin: ChannelPlugin<ResolvedDiscordAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "- Forms: add `components.modal` (title, fields). Haoclaw adds a trigger button and routes submissions as new messages.",
    ],
  },
  messaging: {
