import type {
  ...
  PluginLogger,
} from "haoclaw/plugin-sdk/acpx";
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "haoclaw/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: HaoclawPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: HaoclawPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
