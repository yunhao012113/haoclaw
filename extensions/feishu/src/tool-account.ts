...
import type { HaoclawPluginApi } from "haoclaw/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: HaoclawPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<HaoclawPluginApi, "config">;
