...
import { isSecretRef } from "haoclaw/plugin-sdk/googlechat";
import { createAccountListHelpers, type HaoclawConfig } from "haoclaw/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: HaoclawConfig): ResolvedGoogleChatAccount[] {
