...
import { createAccountListHelpers, type HaoclawConfig } from "haoclaw/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: HaoclawConfig, accountId: string): ZalouserAccountConfig {
