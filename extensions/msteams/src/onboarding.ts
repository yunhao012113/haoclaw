import type {
  ...
  WizardPrompter,
  MSTeamsTeamConfig,
} from "haoclaw/plugin-sdk/msteams";
import {
  DEFAULT_ACCOUNT_ID,
  formatDocsLink,
...
function setMSTeamsDmPolicy(cfg: HaoclawConfig, dmPolicy: DmPolicy) {
...
function setMSTeamsAllowFrom(cfg: HaoclawConfig, allowFrom: string[]): HaoclawConfig {
