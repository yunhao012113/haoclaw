...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "haoclaw/plugin-sdk/msteams";
...
import { resolvePreferredHaoclawTmpDir } from "../../../src/infra/tmp-haoclaw-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredHaoclawTmpDir(), "msteams-mention-"));
