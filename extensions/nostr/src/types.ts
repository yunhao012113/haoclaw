...
} from "haoclaw/plugin-sdk/account-id";
import type { HaoclawConfig } from "haoclaw/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: HaoclawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: HaoclawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: HaoclawConfig): string {
