...
Nostr DM channel plugin for Haoclaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Haoclaw. It enables your bot to:
...
# Configure haoclaw to use local relay
