...
import { createAccountListHelpers, type HaoclawConfig } from "haoclaw/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: HaoclawConfig): ResolvedMattermostAccount[] {
