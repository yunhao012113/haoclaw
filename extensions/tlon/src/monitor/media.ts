...
import { fetchWithSsrFGuard } from "haoclaw/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to Haoclaw workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".haoclaw", "workspace", "media", "inbound");
 ...
 * Format matches Haoclaw's expected attachment structure.
 */
