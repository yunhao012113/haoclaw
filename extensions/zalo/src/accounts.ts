import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "haoclaw/plugin-sdk/account-id";
import { createAccountListHelpers, type HaoclawConfig } from "haoclaw/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: HaoclawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: HaoclawConfig): ResolvedZaloAccount[] {
