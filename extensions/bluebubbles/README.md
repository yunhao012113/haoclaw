...
This directory contains the **BlueBubbles external channel plugin** for Haoclaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `haoclaw/plugin-sdk` helpers.
