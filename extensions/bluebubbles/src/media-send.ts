...
import { resolveChannelMediaMaxBytes, type HaoclawConfig } from "haoclaw/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: HaoclawConfig; accountId?: string }): string[] {
