...
import { createAccountListHelpers, type HaoclawConfig } from "haoclaw/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: HaoclawConfig): ResolvedBlueBubblesAccount[] {
