import type {
  ...
  DmPolicy,
  WizardPrompter,
} from "haoclaw/plugin-sdk/bluebubbles";
import {
  DEFAULT_ACCOUNT_ID,
  formatDocsLink,
...
function setBlueBubblesDmPolicy(cfg: HaoclawConfig, dmPolicy: DmPolicy): HaoclawConfig {
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your Haoclaw gateway URL + webhook path",
