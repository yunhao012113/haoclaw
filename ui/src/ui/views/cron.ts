                  ...
                  : nothing
                      ...
                      ${
                        isAgentTurn
                          ? html`
                              <label class="field cron-span-2">
                        ${renderFieldLabel(t("cron.form.failureAlert"))}
                        <select
                      ...
                      ${
                        props.form.failureAlertMode === "custom"
                          ? html`
                              ...
                              <label class="field">
                                ${renderFieldLabel(t("cron.form.failureAlertCooldownSeconds"))}
                                <input
                              ...
                              <label class="field">
                                ...
                                />
                                <div class="cron-help">
                                  ${t("cron.form.failureAlertToHelp")}
                                </div>
                              </label>
                              <label class="field">
