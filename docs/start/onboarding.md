---
summary: "First-run onboarding flow for Haoclaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Haoclaw">
...
<Step title="CLI">
  ...
  The app can install the global `haoclaw` CLI via npm/pnpm so terminal
