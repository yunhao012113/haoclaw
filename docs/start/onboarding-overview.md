---
summary: "Overview of Haoclaw onboarding options and flows"
read_when:
...
Haoclaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`haoclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the Haoclaw app when you want a fully guided setup on macOS. Docs:
