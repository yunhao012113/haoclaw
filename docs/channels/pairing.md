...
read_when:
  ...
  - Reviewing Haoclaw security posture
title: "Pairing"
---

# Pairing

“Pairing” is Haoclaw’s explicit **owner approval** step.
...
Stored under `~/.haoclaw/credentials/`:
...
3. On your phone, open the Haoclaw iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `haoclaw nodes pending/approve`) is a
