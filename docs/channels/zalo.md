...
- Install via CLI: `haoclaw plugins install @haoclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `haoclaw plugins install ./extensions/zalo`
   - From npm (if published): `haoclaw plugins install @haoclaw/zalo`
...
- Approve via:
  - `haoclaw pairing list zalo`
  - `haoclaw pairing approve zalo <CODE>`
...
- Example: `haoclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `haoclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `haoclaw logs --follow`
