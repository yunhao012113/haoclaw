...
Haoclaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Haoclaw also aligns
the install method:
...
When you switch channels with `haoclaw update`, Haoclaw also syncs plugin sources:
