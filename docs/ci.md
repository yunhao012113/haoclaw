---
title: CI Pipeline
description: How the Haoclaw CI pipeline works
...
This fork uses standard GitHub-hosted runners so it can run in a normal personal repository without extra CI infrastructure.
