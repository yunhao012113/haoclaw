...
read_when:
  - You are building a Haoclaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (haoclaw.plugin.json)

Every plugin **must** ship a `haoclaw.plugin.json` file in the **plugin root**.
Haoclaw uses this manifest to validate configuration **without executing plugin
