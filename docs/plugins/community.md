...
read_when:
  - You want to publish a third-party Haoclaw plugin
...
This page tracks high-quality **community-maintained plugins** for Haoclaw.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `haoclaw plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `haoclaw plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect Haoclaw to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/haoclaw-wechat`
  repo: `https://github.com/icesword0760/haoclaw-wechat`
  install: `haoclaw plugins install @icesword760/haoclaw-wechat`
