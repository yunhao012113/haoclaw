...
haoclaw system heartbeat last
haoclaw logs --follow
haoclaw config get agents.defaults.heartbeat
haoclaw channels status --probe
```
...
```bash
haoclaw config get agents.defaults.heartbeat.activeHours
haoclaw config get agents.defaults.heartbeat.activeHours.timezone
haoclaw config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
haoclaw cron list
haoclaw logs --follow
```
