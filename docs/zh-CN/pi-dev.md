...
本指南总结了在 Haoclaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 Haoclaw 状态目录下。默认为 `~/.haoclaw`。如果设置了 `HAOCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.haoclaw.ai/testing
- https://docs.haoclaw.ai/start/getting-started
