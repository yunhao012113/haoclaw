...
Haoclaw selects models in this order:
...
- `agents.defaults.models` is the allowlist/catalog of models Haoclaw can use (plus aliases).
...
haoclaw models set <provider/model>
haoclaw models set-image <provider/model>

haoclaw models aliases list
haoclaw models aliases add <alias> <provider/model>
haoclaw models aliases remove <alias>

haoclaw models fallbacks list
haoclaw models fallbacks add <provider/model>
haoclaw models fallbacks remove <provider/model>
haoclaw models fallbacks clear

haoclaw models image-fallbacks list
haoclaw models image-fallbacks add <provider/model>
haoclaw models image-fallbacks remove <provider/model>
haoclaw models image-fallbacks clear
```

`haoclaw models` (no subcommand) is a shortcut for `models status`.
...
`haoclaw models scan` inspects OpenRouter’s **free model catalog** and can
...
agent directory (default `~/.haoclaw/agents/<agentId>/models.json`). This file
...
This marker-based persistence applies whenever Haoclaw regenerates `models.json`, including command-driven paths like `haoclaw agent`.
