...
You can point Haoclaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Haoclaw
...
- [Anthropic provider](/providers/anthropic) - Native Haoclaw integration with Claude setup-token or API keys
