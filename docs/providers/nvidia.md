---
summary: "Use NVIDIA's OpenAI-compatible API in Haoclaw"
read_when:
  - You want to use NVIDIA models in Haoclaw
...
haoclaw onboard --auth-choice skip
haoclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
