---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Haoclaw"
read_when:
  - You want Xiaomi MiMo models in Haoclaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Haoclaw uses
