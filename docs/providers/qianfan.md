---
summary: "Use Qianfan's unified API to access many models in Haoclaw"
read_when:
...
3. Haoclaw installed on your system
...
4. Copy the API key for use with Haoclaw

## CLI setup

```bash
haoclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Haoclaw Configuration](/gateway/configuration)
