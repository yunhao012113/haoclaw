---
summary: "Use Qwen OAuth (free tier) in Haoclaw"
read_when:
  - You want to use Qwen with Haoclaw
...
If you already logged in with the Qwen Code CLI, Haoclaw will sync credentials
