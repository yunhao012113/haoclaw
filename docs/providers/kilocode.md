---
summary: "Use Kilo Gateway's unified API to access many models in Haoclaw"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in Haoclaw
---
...
```bash
haoclaw onboard --kilocode-api-key <key>
```
...
Haoclaw dynamically discovers available models from the Kilo Gateway at startup. Use
