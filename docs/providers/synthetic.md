---
summary: "Use Synthetic's Anthropic-compatible API in Haoclaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Haoclaw registers it as the
...
Note: Haoclaw's Anthropic client appends `/v1` to the base URL, so use
