...
public enum HaoclawTalkCommand: String, Codable, Sendable {
...
public struct HaoclawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct HaoclawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
