...
public enum HaoclawCanvasA2UICommand: String, Codable, Sendable {
...
public struct HaoclawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct HaoclawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
