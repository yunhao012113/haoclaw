...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: HaoclawProtocol.AnyCodable]?
    {
        ...
        return [
            "id": HaoclawProtocol.AnyCodable(identity.deviceId),
            "publicKey": HaoclawProtocol.AnyCodable(publicKey),
            "signature": HaoclawProtocol.AnyCodable(signature),
            "signedAt": HaoclawProtocol.AnyCodable(signedAtMs),
            "nonce": HaoclawProtocol.AnyCodable(nonce),
        ]
    }
}
