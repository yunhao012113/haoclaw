...
public typealias HaoclawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias HaoclawPlatformImage = UIImage
#endif

public struct HaoclawChatUsageCost: Codable, Hashable, Sendable {
...
public struct HaoclawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: HaoclawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(HaoclawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct HaoclawChatMessageContent: Codable, Hashable, Sendable {
...
public struct HaoclawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [HaoclawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: HaoclawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [HaoclawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: HaoclawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(HaoclawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([HaoclawChatMessageContent].self, forKey: .content) {
...
public struct HaoclawChatHistoryPayload: Codable, Sendable {
...
public struct HaoclawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct HaoclawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [HaoclawSessionPreviewItem]
}

public struct HaoclawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [HaoclawSessionPreviewEntry]

    public init(ts: Int, previews: [HaoclawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct HaoclawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct HaoclawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct HaoclawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct HaoclawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct HaoclawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct HaoclawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: HaoclawPlatformImage?
...
public struct HaoclawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
