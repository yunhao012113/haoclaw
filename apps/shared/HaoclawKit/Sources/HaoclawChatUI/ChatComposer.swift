...
@MainActor
struct HaoclawChatComposer: View {
        ...
        .background {
            ...
            if self.style == .standard {
                let shape = UnevenRoundedRectangle(
                    ...
                    style: .continuous)
                shape
                    .fill(HaoclawChatTheme.composerBackground)
                    .overlay(shape.strokeBorder(HaoclawChatTheme.composerBorder, lineWidth: 1))
        ...
        ScrollView(.horizontal, showsIndicators: false) {
            HStack(spacing: 6) {
                ForEach(
                    ...
                    id: \HaoclawPendingAttachment.id)
                { (att: HaoclawPendingAttachment) in
                    HStack(spacing: 6) {
    ...
    private var editor: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .fill(HaoclawChatTheme.composerField)
                .overlay(
                    RoundedRectangle(cornerRadius: 12, style: .continuous)
                        .strokeBorder(HaoclawChatTheme.composerBorder)))
    ...
    private var connectionPill: some View {
        ...
        .padding(.horizontal, 8)
        .padding(.vertical, 4)
        .background(HaoclawChatTheme.subtleCard)
        .clipShape(Capsule())
    }
