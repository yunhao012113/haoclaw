...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.haoclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return HaoclawConfigFile.defaultWorkspaceURL() }
