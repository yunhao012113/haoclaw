...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .haoclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? HaoclawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? HaoclawPaths.stateDirURL.path
...
extension Notification.Name {
    static let haoclawSelectSettingsTab = Notification.Name("haoclawSelectSettingsTab")
}
