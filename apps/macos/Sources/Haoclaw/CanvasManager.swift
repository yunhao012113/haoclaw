...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.haoclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Haoclaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__haoclaw__/a2ui/").absoluteString + "?platform=macos"
    }
