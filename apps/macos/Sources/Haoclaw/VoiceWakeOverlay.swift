...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.haoclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Haoclaw windows, but below the system’s pop-up menus.
