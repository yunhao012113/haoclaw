...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.haoclaw", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> HaoclawSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: HaoclawSessionPreviewEntry,
    ...
    private static func cache(payload: HaoclawSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: HaoclawChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [HaoclawKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [HaoclawKit.AnyCodable]) -> [HaoclawChatMessage] {
    ...
    private static func previewText(for message: HaoclawChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: HaoclawChatMessage) -> Bool {
    ...
    private static func toolNames(for message: HaoclawChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: HaoclawChatMessage) -> String? {
