...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.haoclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".haoclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.haoclawCommand(
            subcommand: "gateway",
