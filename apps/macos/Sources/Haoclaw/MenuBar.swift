...
struct HaoclawApp: App {
    ...
    private static let logger = Logger(subsystem: "ai.haoclaw", category: "app")
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "ai.haoclaw", category: "Chat")
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        DesktopShortcutManager.ensureDesktopShortcutIfNeeded()
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.25) {
            DesktopWindowOpener.shared.openMainWindow()
        }
