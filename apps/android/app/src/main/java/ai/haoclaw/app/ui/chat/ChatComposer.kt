...
import ai.haoclaw.app.ui.mobileSurface
import ai.haoclaw.app.ui.mobileText
import ai.haoclaw.app.ui.mobileTextSecondary
import ai.haoclaw.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.haoclaw.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.haoclaw.app.ui.mobileFontFamily,
