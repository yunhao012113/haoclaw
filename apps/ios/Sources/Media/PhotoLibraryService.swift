...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: HaoclawPhotosLatestParams) async throws -> HaoclawPhotosLatestPayload {
        ...
        var results: [HaoclawPhotoPayload] = []
        ...
        return HaoclawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> HaoclawPhotoPayload
    {
