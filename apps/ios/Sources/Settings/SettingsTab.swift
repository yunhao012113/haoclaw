...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = HaoclawLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.haoclaw.ios", category: "GatewaySettings")
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Haoclaw agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Haoclaw. "
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Haoclaw is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Haoclaw", value: DeviceInfoHelper.openClawVersionString())
                    }
                }
            }
