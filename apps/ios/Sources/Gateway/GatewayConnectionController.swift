...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [HaoclawCapability.canvas.rawValue, HaoclawCapability.screen.rawValue]
        ...
        if cameraEnabled { caps.append(HaoclawCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(HaoclawCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = HaoclawLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(HaoclawCapability.location.rawValue) }

        caps.append(HaoclawCapability.device.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(HaoclawCapability.watch.rawValue)
        }
        caps.append(HaoclawCapability.photos.rawValue)
        caps.append(HaoclawCapability.contacts.rawValue)
        caps.append(HaoclawCapability.calendar.rawValue)
        caps.append(HaoclawCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(HaoclawCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            HaoclawScreenCommand.record.rawValue,
            HaoclawSystemCommand.notify.rawValue,
            HaoclawChatCommand.push.rawValue,
        ...
        if caps.contains(HaoclawCapability.camera.rawValue) {
            commands.append(HaoclawCameraCommand.list.rawValue)
            commands.append(HaoclawCameraCommand.snap.rawValue)
            commands.append(HaoclawCameraCommand.clip.rawValue)
        }
        if caps.contains(HaoclawCapability.location.rawValue) {
            commands.append(HaoclawLocationCommand.get.rawValue)
        }
        if caps.contains(HaoclawCapability.device.rawValue) {
            commands.append(HaoclawDeviceCommand.status.rawValue)
            commands.append(HaoclawDeviceCommand.info.rawValue)
        }
        if caps.contains(HaoclawCapability.watch.rawValue) {
            commands.append(HaoclawWatchCommand.status.rawValue)
            commands.append(HaoclawWatchCommand.notify.rawValue)
        }
        if caps.contains(HaoclawCapability.photos.rawValue) {
            commands.append(HaoclawPhotosCommand.latest.rawValue)
        }
        if caps.contains(HaoclawCapability.contacts.rawValue) {
            commands.append(HaoclawContactsCommand.search.rawValue)
            commands.append(HaoclawContactsCommand.add.rawValue)
        }
        if caps.contains(HaoclawCapability.calendar.rawValue) {
            commands.append(HaoclawCalendarCommand.events.rawValue)
            commands.append(HaoclawCalendarCommand.add.rawValue)
        }
        if caps.contains(HaoclawCapability.reminders.rawValue) {
            commands.append(HaoclawRemindersCommand.list.rawValue)
            commands.append(HaoclawRemindersCommand.add.rawValue)
        }
        if caps.contains(HaoclawCapability.motion.rawValue) {
            commands.append(HaoclawMotionCommand.activity.rawValue)
            commands.append(HaoclawMotionCommand.pedometer.rawValue)
        }
