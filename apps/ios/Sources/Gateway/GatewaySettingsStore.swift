...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.haoclaw.gateway"
    private static let nodeService = "ai.haoclaw.node"
    private static let talkService = "ai.haoclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.haoclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.haoclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("haoclaw-gateway.log")
    }
