...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.haoclaw.ios", category: "LiveActivity")
    private var currentActivity: Activity<HaoclawActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = HaoclawActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<HaoclawActivityAttributes>.activities
    ...
    private func updateCurrent(state: HaoclawActivityAttributes.ContentState) {
    ...
    private func connectingState() -> HaoclawActivityAttributes.ContentState {
        HaoclawActivityAttributes.ContentState(
    ...
    private func idleState() -> HaoclawActivityAttributes.ContentState {
        HaoclawActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> HaoclawActivityAttributes.ContentState {
        HaoclawActivityAttributes.ContentState(
