...
Haoclaw is the AI that actually does things.
...
It evolved through several names and shells: Warelay -> Clawdbot -> Moltbot -> Haoclaw.
...
Haoclaw has an extensive plugin API.
...
Haoclaw supports MCP through `mcporter`: https://github.com/steipete/mcporter
...
Haoclaw is currently terminal-first by design.
...
Haoclaw is primarily an orchestration system: prompts, tools, protocols, and integrations.
TypeScript was chosen to keep Haoclaw hackable by default.
